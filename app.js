// ============================================================================
// AXION AI - PROFESSIONAL COMPLETE EDITION v15.0
// ============================================================================
// الميزات:
// ✅ أسعار حية من CoinGecko
// ✅ أيقونات CoinMarketCap الحقيقية
// ✅ 6 منصات إعلانية
// ✅ تعدين أوتوماتيكي كل 2.5 ساعة
// ✅ Boost بـ TON (3 خطط)
// ✅ مهام مع عداد 15 ثانية
// ✅ محفظة متكاملة + إحالات
// ✅ Swap + TON Connect + تفعيل 5 TON
// ✅ نافذة التفعيل (Neural Link) تظهر فقط عند الحاجة
// ============================================================================
...
if (tg) {
    ...
    console.log('✅ AXION AI v15.0 Ready');
}
...
// CoinMarketCap Icons (صور حقيقية)
const CMC_ICONS = {
...
// ============================================================================
// 4. DOM ELEMENTS (مع التحقق من الوجود)
// ============================================================================
    ...
    assetsList.innerHTML = `
        <div class="asset-item">
            <div class="asset-left">
                <img src="${CMC_ICONS.AXC}" class="asset-icon-img" alt="AXC">
            ...
            <div class="asset-right">
                <div class="asset-balance">${axcBalanceNum.toLocaleString()} AXC</div>
                <div class="asset-value">$${(axcBalanceNum * CONFIG.axcPrice).toFixed(2)}</div>
            </div>
        </div>
        <div class="asset-item">
            <div class="asset-left">
                <img src="${CMC_ICONS.USDT}" class="asset-icon-img" alt="USDT">
                <div class="asset-info">
                    <h4>Tether</h4>
                    <p>USDT</p>
                </div>
            ...
            <div class="asset-right">
                <div class="asset-balance">${usdtBalanceNum.toLocaleString()} USDT</div>
                <div class="asset-value">$${usdtBalanceNum.toFixed(2)}</div>
            </div>
        </div>
    `;
}
...
function updateMiningUI() {
    ...
    if (miningData.boostType && miningPower) {
        miningPower.textContent = `${miningData.boostType} (×${miningData.miningRate / CONFIG.baseMiningRate})`;
    } else if (miningPower) {
...
// ============================================================================
async function init() {
    console.log('🚀 AXION AI v15.0 Initializing...');
    ...
    if (!userId) {
        showToast('❌ Open from Telegram Bot', 'error');
        return;
    }
